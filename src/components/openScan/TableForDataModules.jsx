      ...
      >
        ...
        <TableBody items={rows}>
          ...
          <TableRow>
            ...
            <TableCell>{JSON.stringify(scan?.result?.dehashed.map(item => [{"email": item.email ? item.email : '-'}, {"ip_address": item.ip_address ? item.ip_address : '-'}, {"username": item.username ? item.username : '-'}, {"password": item.password ? item.password : '-'}, {"name": item.name ? item.name : '-'}]))}</TableCell>
          </TableRow>
          <TableRow>
